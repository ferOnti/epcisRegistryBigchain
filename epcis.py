...
print ("EPCIS Registry in BigchainDB ingestion script")

epcidnr = "urn:epcid:00" + str(random.randrange(1000,9999))
epcidnr = "urn:epcid:007446"
epcis_data = {
    'epcid': epcidnr,
    'bizStep': 'receiving',
...
epcisService.saveEpcis(epcis_data)
